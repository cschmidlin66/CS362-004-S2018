...
void adventurerEffect(int drawntreasure, int currentPlayer, int nextplayer, struct gameState *state, int z){
  ...
  if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold)
    ...
    //correct is temphand[z]=cardDrawn;
...
void villageEffect(int currentPlayer, int handPos, struct gameState *state){
  ...
  //+2 Actions
  // correct is state->numActions = state->numActions + 2;
...
void great_hallEffect(int currentPlayer, int handPos, struct gameState *state){
   //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerEffect(drawntreasure, currentPlayer, nextPlayer, state, z);
    ...
    case great_hall:
      great_hallEffect(currentPlayer, handPos, state);
      return 0;
